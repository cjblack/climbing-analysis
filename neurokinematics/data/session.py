...
class ExperimentSession:
    ...
    def preprocess_and_align(self):
        ...
        self.run_pose_processing()
        self.run_spike_sorting()
        self.run_lfp_processing()
        self.align_video()
        self.align_movements()
    ...
    def run_lfp_processing(self, mode: str = "skip"):
        ...
        # overwrite utility
        expected_output = self.dirs['lfp'] / 'lfp_processed'
    ...
    def epoch_spikes(self, mode: str = "skip"):
        ...
        """
        # need to add validation logic
        self.sorter = load_phy_sorting(self.dir['spikes'])

[![Unit Test](https://github.com/cjblack/climbing-analysis/actions/workflows/session_class_test.yml/badge.svg)](https://github.com/cjblack/climbing-analysis/actions/workflows/session_class_test.yml)
 ...
 ```bash
conda create -f environment_redux.yml
 ```
 
 # Overview

 This repository provides a pipeline for processing and analysing electrophysiology and markerless pose estimation data from behavioural neuroscience experiments.
